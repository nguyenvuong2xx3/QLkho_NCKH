...
{
    public abstract class QLKho_NCKHWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QLKho_NCKHWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QLKho_NCKHWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QLKho_NCKHDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QLKho_NCKHDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QLKho_NCKHDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QLKho_NCKHDbContext, Task<T>> func)
        {
            T result;
